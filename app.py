...
import os
import io # PERBAIKAN: Import modul io
...
# --- FUNGSI PEMBANTU ---
# PERBAIKAN: Fungsi generate_pdf_profil_siswa diubah untuk mengembalikan objek FPDF
...
    return pdf # PERBAIKAN: Langsung kembalikan objek PDF
...
                        # PERBAIKAN UTAMA: Dapatkan objek PDF, bukan output biner
                        pdf = generate_pdf_profil_siswa(
                            nama_terpilih,
                            siswa_data_for_pdf,
                            siswa_data["Klaster"],
                            st.session_state.cluster_characteristics_map
