...
                # Jika ada error encoding, coba bersihkan karakter
...
        st.error(f"Terjadi kesalahan saat menyiapkan laporan PDF: {e}")
        # Jika gagal, kembalikan None agar tidak terjadi error saat download
        return None
...
    if uploaded_file:
        try:
            # Pastikan menggunakan engine 'openpyxl' untuk .xlsx
...
                            st.session_state.cluster_characteristics_map
                        )
                    # Periksa apakah PDF berhasil dibuat sebelum diunduh
                    if pdf_data_bytes:
...
                        )
                    else:
                        st.error("Gagal membuat file PDF. Silakan coba lagi atau periksa data siswa.")
            else:
